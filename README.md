...
program to calculate the information gain after split of data.Project 1:
...
6) Measure the performance of the modelProject 2:
...
• Use the trained model to perform some predictions on test data.Project 3:
...
7. Measure the performance of the modelProject: 4
...
the training.Practice: Exercise 1
