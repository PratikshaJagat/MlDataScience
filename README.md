# MlDataScience
It contains the data science and ml projects.
Mini Project: 
...
Hint:
 Import the Worldwide_happiness_report.csv file as happiness_report. Drop 'Overall rank', 'Score', 'Generosity', 'Perceptions of corruption' columns. Set ‘Country 
